...
function MyAccount() {
  ...
  const updateRemote = async (updates) => {
    try {
      await axios.patch(`https://itlearners-f748d-default-rtdb.firebaseio.com/user/${profile.id}.json`, updates);
  ...
  return (
    <div className="container py-5">
      <div className="d-flex align-items-center mb-4">
        <i className="fa fa-user-circle fa-2x text-primary me-2" />
        <h2 className="m-0">Hi, {profile.name || "User"}</h2>
      </div>
